                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($categories as $index=>$category)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $category->name }}</td>
                                    {{--<td>{{ $category->mangs->count() }}</td>--}}
                                    <td><a href="{{ route('dashboard.mangs.index', ['category_id' => $category->id]) }}" class="btn btn-info btn-sm">الادرات الملحقة</a></td>                                    <td>

                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($clients as $index=>$client)
                                <tr>
                                    ...
                                    <td><a href="{{ route('dashboard.workers.index',['client_id' =>$client->id ]) }}" class="btn btn-info btn-sm">العمالة المرتبطة</a></td>
                                    {{--<td><a href="{{ route('dashboard.mangs.index', ['category_id' => $category->id]) }}" class="btn btn-info btn-sm">الادرات الملحقة</a></td>--}}
                                    <td>
